...
describe FundsController do
  ...
  #       post :create, {:fund => { "name" => "invalid value" }}, valid_session
  #       assigns(:fund).should be_a_new(Fund)
  #     end
  # 
  ...
  #       Fund.any_instance.should_receive(:update).with({ "name" => "MyString" })
  #       put :update, {:id => fund.to_param, :fund => { "name" => "MyString" }}, valid_session
  #     end
  # 
  #     it "assigns the requested fund as @fund" do
  #       fund = Fund.create! valid_attributes
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Fund.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => fund.to_param, :fund => { "name" => "invalid value" }}, valid_session
  #       assigns(:fund).should eq(fund)
  #     end
  # 
