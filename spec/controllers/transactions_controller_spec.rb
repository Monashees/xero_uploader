...
describe TransactionsController do
  ...
  #       post :create, {:transaction => { "fund_id" => "invalid value" }}, valid_session
  #       assigns(:transaction).should be_a_new(Transaction)
  #     end
  # 
  ...
  #       Transaction.any_instance.should_receive(:update).with({ "fund_id" => "" })
  #       put :update, {:id => transaction.to_param, :transaction => { "fund_id" => "" }}, valid_session
  #     end
  # 
  #     it "assigns the requested transaction as @transaction" do
  #       transaction = Transaction.create! valid_attributes
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Transaction.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => transaction.to_param, :transaction => { "fund_id" => "invalid value" }}, valid_session
  #       assigns(:transaction).should eq(transaction)
  #     end
  # 
